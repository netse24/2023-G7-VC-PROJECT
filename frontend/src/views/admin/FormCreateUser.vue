<template>
  <section>
    <base-button color="#1034a6"  @click="showDialog" class="ml-10 text-white">CREATE USER</base-button>
          ...
          <template #body>
            <v-sheet width="auto">
              ...
              <v-form @submit.prevent="createUser">
                <v-row class="d-flex">
                  <v-col>
                    <v-text-field required density="compact" v-model="firstName" label="Enter Firstname"
                      :rules="firstNameRules" prepend-inner-icon="mdi-account-box">
                    </v-text-field>
                  </v-col>
                  <v-col>
                ...
                <v-row v-if="isTeacher">
                  <v-col>
                    <v-text-field density="compact" v-model="course" label="Enter Course For teacher" :rules="courseRules"
                ...
                <v-row v-if="isStudent">
                  ...
                  <v-col>
                    <v-text-field prepend-inner-icon="mdi mdi-school" density="compact" v-model="classes"
                      label="Enter Classe For Student" :rules="classesRules">
                    </v-text-field>
                  </v-col>
                  <v-col @click="getRoom">
                    <v-select prepend-inner-icon="mdi mdi-domain" density="compact" v-model="selectedRoom"
                      label="Choose Room" :rules="roomRules" :items="roomList">
                    </v-select>
                  </v-col>
                </v-row>
                <v-list class="d-flex justify-space-between">
                  <v-btn @click="clearForm" type="#####" class="bg-grey-lighten-1">CANCEL</v-btn>
